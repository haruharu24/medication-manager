...
const ja = {
  ...
  settings: {
    ...
    medicalContacts: '薬局・病院の連絡先',
    medicalContactsDesc: 'かかりつけ薬局・病院の情報',
    reportCreate: 'レポート作成',
...
const en: typeof ja = {
  ...
  settings: {
    ...
    medicalContacts: 'Pharmacy & hospital contacts',
    medicalContactsDesc: 'Your pharmacy and hospital info',
